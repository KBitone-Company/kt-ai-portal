...
- [x] 사용자 등록 신청 상세 화면
- [x] 본인확인 상태 표시
- [x] 사용자 승인/반려/보완요청/재신청 mock workflow
- [x] 외부 사용자 계정 조회/등록/수정 화면
- [x] 사용자 소속/역할/접속 가능 서비스 설정 화면
- [x] 사용자 상태 변경 이력 표시
- [x] Keycloak/DB 연동 설계 문서 작성 (`docs/USER_MANAGEMENT_DESIGN.md`)
...
- [ ] 신규 프로그램 등록 화면
- [ ] 권한 변경 이력 표시
- [ ] Keycloak role/group claim 연동 설계 문서 작성
